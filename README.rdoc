...
* As a beginner programer, I spent extra time to designe the logic relationships between different data sets contained in this app: movies, theaters, orders, showtimes etc, plan on views with UI/UX researches. First to get the app running, then start to work on more challenging features. 
